...
public class Shader extends ShaderProgram {
	 ...
	 */
	private static final String VERTEX_FILE = "src/com/github/eagl/shaders/vertexShader.txt";
	/**
	 * The location of the Fragment Shader file
	 */
	private static final String FRAGMENT_FILE = "src/com/github/eagl/shaders/fragmentShader.txt";
