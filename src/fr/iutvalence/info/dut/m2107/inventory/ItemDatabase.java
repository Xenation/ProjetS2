...
public class ItemDatabase {
	...
	public static void create() {
		...
		itemDatabase.add(new Arrow	(SpriteDatabase.getArrowSpr(),			new Collider(-.02f, -.02f, .02f, .02f), (short) 15,		(short)0, 	"Arrow",			"A basic arrow", 		Rarity.POOR,		(short)50,		(short)1,		(short)1,		(short)1));
		itemDatabase.add(new Arrow	(SpriteDatabase.getLightningArrowSpr(),	new Collider(-.02f, -.02f, .02f, .02f),	(short) 30,	(short)1,	"Lightning Arrow", 	"A lightning arrow",	Rarity.UNCOMMON,	(short)25,		(short)5,		(short)2,		(short)20));
		...
		itemDatabase.add(new Arrow	(SpriteDatabase.getFrozenArrowSpr(),	new Collider(-.02f, -.02f, .02f, .02f),	(short)21,	(short)4,	"Frozen Arrow", 	"A frozen arrow",		Rarity.UNCOMMON,	(short)25,		(short)5,		(short)2,		(short)3));
		itemDatabase.add(new Arrow	(SpriteDatabase.getBurningArrowSpr(),	new Collider(-.02f, -.02f, .02f, .02f),	(short)21,	(short)5,	"Burning Arrow", 	"A burning arrow",		Rarity.UNCOMMON,	(short)25,		(short)5,		(short)2,		(short)3));
		...
		itemDatabase.add(new Bullet(SpriteDatabase.getBulletSpr(), new Collider(-.02f, -.02f, .02f, .02f), (short) 50, (short)7, "A bullet", "A bullet", Rarity.COMMON, (short)500, (short)1, (short)2, (short)5));
		...
		itemDatabase.add(new Orb(SpriteDatabase.getAirOrbSpr(), new Collider(-0.25f, -0.25f, 0.25f, 0.25f), (short)2, (short)9, "Air Orb", "An air orb", Rarity.POOR, (short)1, (short)1, (short)5, (short)10));
	}
